...
public abstract class PackageController
{
    ...
    public Response status()
    {
        ...
        try {
            UriBuilder uriBuilder = fromUri("http://localhost").port(8080/*informer.getPrestoPort()*/).path("/v1/info");
            ...
            // TODO: Deserialize this as JSON instead of as a string
//            JsonNode state = prestoState.readEntity(JsonNode.class);
...
//            try {
//                jsonBuilder.put("running-coordinator", informer.isRunningCoordinator());
//            }
//            catch (IOException e) {
//                LOGGER.warn(e, "IOException while checking if coordinator");
//            }
