...
public class PrestoConfigUtils
{
    ...
    @Inject
    PrestoConfigUtils(AgentConfig config, CommandExecutor executor)
    {
        defaultConfig = config.getDefaultConfigurationDirectory();
        defaultCatalog = config.getDefaultCatalogDirectory();
